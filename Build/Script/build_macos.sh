...
echo "Building CYGoLogger for macOS..."
...
echo "  $BUILD_DIR/Bin/simple_example"
echo "  $BUILD_DIR/Bin/simple_logger_test"
echo "  $BUILD_DIR/Bin/console_test"
echo "  $BUILD_DIR/Bin/simple_test"
